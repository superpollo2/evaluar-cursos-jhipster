...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACADEMICPERIOD_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACADEMICPERIOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACADEMICPERIOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACADEMICPERIOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACADEMICPERIOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACADEMICPERIOD actions', async () => {
      const expectedActions = [
        {
