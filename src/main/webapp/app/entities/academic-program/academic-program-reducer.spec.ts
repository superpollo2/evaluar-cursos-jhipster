...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACADEMICPROGRAM_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACADEMICPROGRAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACADEMICPROGRAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACADEMICPROGRAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACADEMICPROGRAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACADEMICPROGRAM actions', async () => {
      const expectedActions = [
        {
