...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSEQUESTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_COURSEQUESTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COURSEQUESTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COURSEQUESTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COURSEQUESTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COURSEQUESTION actions', async () => {
      const expectedActions = [
        {
