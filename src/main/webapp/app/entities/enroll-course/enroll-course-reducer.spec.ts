...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENROLLCOURSE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ENROLLCOURSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ENROLLCOURSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ENROLLCOURSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ENROLLCOURSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ENROLLCOURSE actions', async () => {
      const expectedActions = [
        {
