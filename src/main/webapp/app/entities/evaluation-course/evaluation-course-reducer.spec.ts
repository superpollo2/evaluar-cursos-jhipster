...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './evaluation-course.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EVALUATIONCOURSE_LIST actions', async () => {
    ...
    it('dispatches FETCH_EVALUATIONCOURSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EVALUATIONCOURSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EVALUATIONCOURSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EVALUATIONCOURSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EVALUATIONCOURSE actions', async () => {
      const expectedActions = [
        {
