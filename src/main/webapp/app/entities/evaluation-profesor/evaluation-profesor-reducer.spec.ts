...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './evaluation-profesor.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EVALUATIONPROFESOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_EVALUATIONPROFESOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EVALUATIONPROFESOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EVALUATIONPROFESOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EVALUATIONPROFESOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EVALUATIONPROFESOR actions', async () => {
      const expectedActions = [
        {
