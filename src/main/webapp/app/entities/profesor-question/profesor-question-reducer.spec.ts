...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './profesor-question.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROFESORQUESTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROFESORQUESTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROFESORQUESTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROFESORQUESTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROFESORQUESTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROFESORQUESTION actions', async () => {
      const expectedActions = [
        {
