...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './total-score-course.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOTALSCORECOURSE_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOTALSCORECOURSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOTALSCORECOURSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOTALSCORECOURSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOTALSCORECOURSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOTALSCORECOURSE actions', async () => {
      const expectedActions = [
        {
