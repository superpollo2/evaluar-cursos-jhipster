...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './total-score-profesor.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOTALSCOREPROFESOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOTALSCOREPROFESOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOTALSCOREPROFESOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOTALSCOREPROFESOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOTALSCOREPROFESOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOTALSCOREPROFESOR actions', async () => {
      const expectedActions = [
        {
