  ...
  return (
    <div>
      <h2 id="user-o-heading" data-cy="UserOHeading">
        <Translate contentKey="evaluarCursosApp.userO.home.title">User OS</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="evaluarCursosApp.userO.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/user-o/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="evaluarCursosApp.userO.home.createLabel">Create new User O</Translate>
          </Link>
        </div>
      </h2>
        ...
        {userOList && userOList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="evaluarCursosApp.userO.home.notFound">No User OS found</Translate>
            </div>
          )
        )}
      </div>
